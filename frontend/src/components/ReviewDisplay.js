    ...
    <div className={styles.review_container} key={props.id}>
      {editComplete ? (
        <>
          ...
          {props.is_owner ? (
            <>
              <button className={styles.btn_review} onClick={EditStatusSetter}>
                Edit
              </button>
              <button className={styles.btn_review} onClick={DeleteModal}>
                Delete
              </button>
            </>
          ) : null}
        ...
        <>
          ...
          >
            <Modal.Dialog>
              ...
              <Modal.Footer>
                <Button onClick={DeleteModal} variant="secondary">
                  Cancel
                </Button>
